...
import diffsxtn from '../assets/img/7erros/diffsxtn.png';
import sxtn from '../assets/img/7erros/sxtn.png';
import diffsvtn from '../assets/img/7erros/diffsvtn.png';
import svtn from '../assets/img/7erros/svtn.png';
import diffeitn from '../assets/img/7erros/diffeitn.png';
import eitn from '../assets/img/7erros/eitn.png';
import diffnntn from '../assets/img/7erros/diffnntn.png';
import nntn from '../assets/img/7erros/nntn.png';
import difftwt from '../assets/img/7erros/difftwt.png';
import twt from '../assets/img/7erros/twt.png';
import difftwtone from '../assets/img/7erros/difftwtone.png';
import twtone from '../assets/img/7erros/twtone.png';
import difftwttwo from '../assets/img/7erros/difftwttwo.png';
import twttwo from '../assets/img/7erros/twttwo.png';
import difftwtthree from '../assets/img/7erros/difftwtthree.png';
import twtthree from '../assets/img/7erros/twtthree.png';
import difftwtfour from '../assets/img/7erros/difftwtfour.png';
import twtfour from '../assets/img/7erros/twtfour.png';
import difftwtfive from '../assets/img/7erros/difftwtfive.png';
import twtfive from '../assets/img/7erros/twtfive.png';
import difftwtsix from '../assets/img/7erros/difftwtsix.png';
import twtsix from '../assets/img/7erros/twtsix.png';
import difftwtsv from '../assets/img/7erros/difftwtsv.png';
import twtsv from '../assets/img/7erros/twtsv.png';
import difftwtei from '../assets/img/7erros/difftwtei.png';
import twtei from '../assets/img/7erros/twtei.png';
import difftwtnn from '../assets/img/7erros/difftwtnn.png';
import twtnn from '../assets/img/7erros/twtnn.png';
...
export const Texts = {
  ...
  Games:{
    Menus:{
      ...
      ranking:'Pontuação global',
    },
    Modes:{
      single:'1 Jogador',
      multiple:'2 Jogadores',
      classic:'Clássico',
      histories:'Histórias'
    },
    Messages:{
  ...
  DiffCards:[
    ...
    {
      name: "Uvas",
      resume:'As uvas eram usadas para fazer vinho. Vinho, na Bíblia, representa alegria. VOcê sabia que o primeiro milagre de Jesus foi em uma festa de casamento? Nessa festa havia acabado o vinho, então chamaram Jesus e Ele transformou a água em vinho! Com Jesus em nossas vidas não haverá falta de alegria que seja permanente!',
      diff1: 5,
      diff2: 6,
      diff3: 7,
      diff4: 8,
    ...
    {
      name: "Cachorrinhos",
      resume:'Você tem cachorrinhos em casa? Certa vez uma mulher queria muito um milagre de Jesus e foi graças a exemplo dos cachorrinhos que ela conseguiu demonstrar o tamanho da sua fé. VOcê sabia disso? Leia mais em Mateus 15:21-39!',
      diff1: 2,
      diff2: 4,
      diff3: 10,
      diff4: 11,
    ...
    {
      name: "Miriã e seu pandeiro",
      resume:'Miriã se alegrou muito quando o povo de Israel conseguiu escapar dos egípcios graças ao que Deus havia deito! Com tanta alegria, Miriã adorou ao SENHOR cantando e batendo em seu pandeiro. Quais motivos você tem para se alegrar e adorar ao SENHOR hoje? Faça isso!',
      diff1: 2,
      diff2: 4,
      diff3: 7,
      diff4: 9,
    ...
    {
      name: "Rubis",
      resume:'Rubis são pedras muito preciosas e valiosas! A Bíblia compara a mulher prudente ao valor de muitos rubis. Salomão, ao escrever Provérbios reconhece como uma mulher que acredita e adora a Deus é valiosa!',
      diff1: 1,
      diff2: 2,
      diff3: 5,
      diff4: 8,
    ...
    {
      name: "Porcos",
      resume:'Certa vez um homem endemoniado se aproximou correndo. Esse homem estava possuído por muitos demônios, e eles temiam que Jesus os enviasse para a perdição eterna. O homem caiu aos pés de Jesus e implorou: “Não nos envie para o abismo!” Os demônios sabiam que Jesus tinha poder sobre eles. Eles pediram permissão para entrar em uma manada de porcos que pastava ali perto. Jesus permitiu. Imediatamente, os porcos ficaram agitados. Eles correram em direção a um penhasco e se jogaram no mar.',
      diff1: 2,
      diff2: 4,
      diff3: 5,
      diff4: 7,
    ...
    {
      name: "Coroa",
      resume:'Na Bíblia, está escrito: “Bem-aventurado o varão que sofre a tentação; porque, quando for aprovado, receberá a coroa da vida” (Tiago 1:12). Isso significa que, quando enfrentamos desafios e permanecemos firmes na nossa fé, Deus nos recompensa com essa coroa especial. E você, querido leitor, também pode ganhar a Coroa da Vida. Basta amar a Deus, ser fiel e nunca desistir, mesmo quando as coisas ficam difíceis.',
      diff1: 0,
      diff2: 2,
      diff3: 3,
      diff4: 7,
    ...
    {
      name: "Pomba",
      resume:'A pomba é usada na Bíblia como símbolo de paz, o Espírito Santo, pureza e ternura.',
      diff1: 1,
      diff2: 5,
      diff3: 6,
      diff4: 7,
    ...
    {
      name: "Calebe",
      resume:'Calebe era um dos doze espias enviados por Moisés para explorar a Terra Prometida, chamada Canaã. Enquanto os outros espias ficaram com medo, Calebe permaneceu destemido. Ele viu as cidades altas e os habitantes fortes, mas não se deixou intimidar. Ele acreditava nas promessas de Deus e sabia que, com a ajuda divina, eles poderiam conquistar a terra.',
      diff1: 1,
      diff2: 4,
      diff3: 5,
      diff4: 6,
    ...
    {
      name: "Pastoreio",
      resume:'Você sabia que pastor é um dos 5 ministérios de Deus para a sua Igreja? Nos tempos antigos, pastores eram aqueles que cuidavam de um rebanho, mas atualmente, em nossas igrejas, há pastores que servem para nos auxiliar em nossa caminhada cristã para que sejamos mais parecidos com Cristo! Você quer ser pastor um dia? Eu quero!',
      diff1: 2,
      diff2: 4,
      diff3: 5,
      diff4: 6,
    ...
    {
      name: "Mula de Balaão",
      resume:'Certa vez Deus fez uma mula falar! É sério! Em Números 22 nós encontramos essa história. Isso aconteceu para que Balaão correspondesse ao Senhor, pois seu coração, até então, não era bom. Nada é impossível pra Deus!',
      diff1: 0,
      diff2: 6,
      diff3: 7,
      diff4: 9,
    ...
    {
      name: "Exército de anjos",
      resume:'Os anjos eram mensageiros de Deus e serviam como guardiões e protetores. Eles eram invisíveis aos olhos humanos, mas desempenhavam um papel vital no plano divino, incluindo a proteção do povo de Deus em momentos específicos na história.',
      diff1: 0,
      diff2: 3,
      diff3: 5,
      diff4: 7,
    ...
    {
      name: "Zacarias e Isabel",
      resume:'Eles eram um casal especial, unido pela fé em Deus e por laços profundos de amor. Enquanto Zacarias oferecia incenso no altar, um anjo apareceu ao seu lado. O anjo disse: “Isabel dará à luz um filho, e vocês o chamarão de João.” Zacarias ficou surpreso e até duvidou, mas o anjo garantiu que era verdade. Isabel e Zacarias ficaram maravilhados. Eles sabiam que Deus estava agindo em suas vidas. E assim, Isabel engravidou, apesar de sua idade avançada. João, o precursor de Jesus, estava a caminho.',
      diff1: 1,
      diff2: 3,
      diff3: 4,
      diff4: 5,
    ...
    {
      name: "Jesus e as crianças",
      resume:'Certa vez Jesus ensinou aos seus seguidores uma lição importante: Ele disse: “Para entrar no Reino dos Céus, precisamos ser como crianças.” Mas o que isso significava? Significava ser humilde, como uma criança que confia plenamente em seus pais. Significava ter fé simples e sincera, sem dúvidas complicadas. Significava amar sem reservas, como as crianças amam, sem medo do que os outros pensam.',
      diff1: 0,
      diff2: 3,
      diff3: 7,
      diff4: 8,
  ...
  Characters:[
    {
      name: "A sunamita",
      img:sunamita,
      resume: "Mulher sunamita:\nQuem foi? Ela era uma mulher da cidade de Suném.\nO que ela fez? Ela mostrou hospitalidade a Eliseu, um profeta de Deus, e construiu um quarto especial para ele em sua casa.\nLição para nós: Ser gentil e hospitaleiro com os outros."
    },
    {
      name: "Abigail",
      img:abigail,
      resume: "Abigail:\nQuem foi? Abigail era uma mulher sábia e corajosa.\nO que ela fez? Ela impediu uma briga entre Davi e seu marido, Nabal, oferecendo presentes e palavras gentis.\nLição para nós: Ser pacificador e usar a sabedoria para resolver conflitos."
    },
    {
      name: "Abraão",
      img:abraao,
      resume: "Abraão\nQuem foi Abraão?\nAbraão é conhecido como o pai da fé.\nDeus fez uma aliança especial com ele.\nFeitos de Abraão:\nEle deixou sua terra natal e seguiu a Deus.\nAbraão é o ancestral de Israel.\nLições Importantes:\nAbraão nos ensina sobre confiança, obediência e esperança.\nDeus cumpre Suas promessas."
    },
    {
      name: "Absalão",
      img:absalao,
    ...
    },
    {
      name: "Alaúde",
      img:alaude,
      resume: "O Alaúde na Bíblia\nO Que é o Alaúde?\nO alaúde é um instrumento musical antigo.\nEle se parece com um violão, mas tem um formato diferente.\nO Alaúde na Bíblia:\nO alaúde é mencionado apenas em Daniel 3:10-17.\nFoi usado na Babilônia durante o reinado do rei Nabucodonosor.\nLições Importantes:\nO alaúde nos lembra que a música pode ser uma forma de adoração a Deus.\nAssim como o alaúde era tocado na Bíblia, podemos usar nossos talentos para louvar a Deus."
    },
    {
      name: "Ana",
      img:ana,
      resume: "Ana:\nQuem foi? Ana era uma mulher que desejava muito ter um filho.\nO que ela fez? Ela orou fervorosamente a Deus e prometeu dedicar seu filho a Ele.\nLição para nós: Orar com fé e confiar em Deus."
    },
    {
      name: "Arão",
      img:arao,
      resume: "Arão\nQuem foi Arão?\nArão era o irmão mais velho de Moisés.\nEle se tornou o primeiro sumo sacerdote de Israel.\nPapel de Arão:\nArão apoiou Moisés em sua liderança.\nEle ajudou a conduzir o povo durante o Êxodo.\nLições Importantes:\nArão nos ensina sobre apoio mútuo e serviço a Deus.\nDeus usa equipes para cumprir Seus planos."
    },
    {
      name: "Arca de Noé",
      img:arcanoe,
    ...
    },
    {
      name: "Árvore frutífera",
      img:arvorefrutifera,
      resume: "A Parábola da Árvore Frutífera\nO Que é uma Árvore Frutífera?\nUma árvore frutífera produz frutos como maçãs, uvas ou laranjas.\nEla precisa ser cuidada para dar bons frutos.\nA Parábola da Árvore Frutífera:\nJesus disse que conhecemos as árvores pelos frutos que elas dão.\nAssim como as árvores, nossas ações mostram quem somos.\nComo Ser uma Árvore Boa?\nDevemos ter amor, bondade, paciência e outros frutos do Espírito.\nAssim, seremos árvores frutíferas que agradam a Deus."
    },
    {
    ...
    {
      name: "Capacete da salvação",
      img:capacetesalvacao,
      resume: "O Capacete da Salvação\nO Que é o Capacete da Salvação?\nO capacete da salvação é uma parte importante da armadura de Deus.\nEle protege nossa mente e nossos pensamentos.\nO Significado Espiritual do Capacete da Salvação:\nQuando confiamos em Jesus, recebemos a salvação.\nO capacete nos lembra que somos salvos e que Deus cuida de nós.\nComo Usar o Capacete da Salvação:\nQuando pensamos em coisas boas, lembramos das promessas de Deus.\nQuando dúvidas ou medos surgem, o capacete nos protege.\nLições Importantes:\nO capacete da salvação nos ajuda a pensar certo.\nQuando confiamos em Jesus, temos segurança e esperança.\nLembre-se sempre: Deus nos protege e nos ajuda a fazer o que é certo!"
    },
    {
      name: "Casa sobre a rocha",
      img:casarocha,
      resume: "Vamos aprender sobre a parábola da casa sobre a rocha de forma simples e divertida:\n\nO Que é a Parábola?\nUma parábola é uma história contada por Jesus para ensinar lições importantes.\nA Casa na Rocha e na Areia:\nJesus contou uma história sobre duas casas.\nUma foi construída sobre rocha e a outra sobre areia.\nA Tempestade e a Casa Firme:\nQuando veio a chuva e o vento, a casa na rocha permaneceu firme.\nMas a casa na areia desabou!\nLições Importantes:\nA rocha simboliza Jesus e a fé nEle.\nSe construirmos nossa vida sobre Ele, seremos fortes.\nQuando enfrentarmos tempestades (problemas), estaremos seguros.\nLembre-se sempre: construa sua vida sobre a rocha de Jesus!"
    },
    {
      name: "Coluna de fogo",
      img:colunafogo,
    ...
    },
    {
      name: "Dracma",
      img:dracma,
      resume: "A Parábola da Dracma Perdida\nO Que é uma Dracma?\nA dracma era uma moeda antiga de muito valor emocional.\nEla era usada em compromissos e como símbolo de aliança.\nA Parábola da Dracma Perdida:\nJesus contou que uma mulher tinha dez dracmas, mas uma delas se perdeu.\nEla procurou com cuidado até encontrar a moeda perdida.\nO Significado Espiritual da Dracma Perdida:\nA dracma representa pessoas que estão perdidas espiritualmente.\nDeus nos busca com amor e determinação para nos trazer de volta a Ele.\nLições Importantes:\nAssim como a mulher procurou a dracma, Deus nos procura com amor.\nEle se alegra quando nos arrependemos e voltamos para Ele."
    },
    {
      name: "Elias",
      img:elias,
    ...
    },
    {
      name: "Escudo da fé",
      img:escudofe,
      resume: "Vamos aprender sobre o Escudo da Fé de forma simples e divertida:\n\nO Que é o Escudo da Fé?\nO escudo da fé é uma imagem que a Bíblia usa para mostrar como a fé nos ajuda.\nÉ como um escudo protetor que usamos nas batalhas da vida.\nO Significado do Escudo da Fé:\nQuando confiamos em Deus, nossa fé é como um escudo.\nEle nos protege dos dardos (setas) que o inimigo lança contra nós.\nComo Usar o Escudo da Fé:\nQuando algo nos assusta ou nos faz duvidar, podemos lembrar da nossa fé.\nDizemos coisas como: “Eu confio em Deus!” ou “Ele está no controle!”.\nLições Importantes:\nO escudo da fé nos ajuda a não cair e nem sermos derrotados.\nQuando confiamos em Deus, Ele nos protege e nos dá coragem.\nLembre-se sempre: confie em Deus e use o seu escudo da fé!"
    },
    {
      name: "Espada",
      img:espada,
    ...
    },
    {
      name: "Funda",
      img:funda,
      resume: "Vamos aprender sobre a funda de Davi de forma simples e divertida:\n\nO Que é uma Funda?\nA funda é uma ferramenta antiga usada para lançar pedras ou outros objetos.\nEla consiste em duas cordas conectadas a uma bolsa de couro.\nDavi e o Gigante Golias:\nDavi era um jovem pastor corajoso.\nEle enfrentou o gigante Golias, que zombava do povo de Deus.\nA Escolha da Funda:\nDavi não era um guerreiro forte, mas ele confiava em Deus.\nEle escolheu sua funda e cinco pedras lisas do riacho.\nO Lançamento Preciso:\nQuando Golias viu Davi se aproximando, ele riu.\nMas Davi não teve medo. Ele colocou uma pedra na funda, girou e lançou com força.\nA pedra acertou Golias na testa, e ele caiu!\nLições Importantes:\nA história da funda de Davi nos ensina sobre coragem, fé e confiança em Deus.\nMesmo sendo pequenos, podemos enfrentar grandes desafios com a ajuda de Deus.\nLembre-se sempre: Deus nos dá força para vencer nossos gigantes!"
    },
    {
      name: "Harpa",
      img:harpa,
    ...
    },
    {
      name: "Lídia",
      img:lidia,
      resume: "Lídia:\nQuem foi? Lídia era uma comerciante de púrpura que se tornou cristã.\nO que ela fez? Ela ouviu o Evangelho de Paulo e se converteu, abrindo sua casa para os apóstolos.\nLição para nós: Ser hospitaleiro e seguir a Jesus."
    },
    {
      name: "Lucas",
      img:lucas,
      resume: "Lucas\nQuem foi Lucas?\nLucas era um médico e companheiro de Paulo.\nEle escreveu o Evangelho de Lucas e o Livro de Atos.\nFeitos de Lucas:\nLucas valorizava a misericórdia e a cura.\nEle nos mostra como Jesus ama a todos, inclusive os doentes.\nLições Importantes:\nLucas nos ensina sobre compaixão e fé em Jesus."
    },
    {
      name: "Mar de sangue",
      img:marsangue,
    ...
    },
    {
      name: "Marcos",
      img:marcos,
      resume: "Marcos\nQuem foi Marcos?\nMarcos era um discípulo de Jesus.\nEle escreveu o Evangelho de Marcos.\nFeitos de Marcos:\nMarcos registrou os milagres e ensinamentos de Jesus.\nEle nos mostra a importância de seguir Jesus.\nLições Importantes:\nMarcos nos ensina sobre serviço e compromisso com Jesus."
    },
    {
      name: "Maria",
      img:maria,
      resume: "Maria, Mãe de Jesus\nQuem foi Maria?\nMaria foi a mãe de Jesus.\nEla era uma mulher humilde e fiel.\nFeitos de Maria:\nMaria recebeu a anunciação do anjo sobre o nascimento de Jesus.\nEla deu à luz Jesus em Belém.\nLições Importantes:\nMaria nos ensina sobre obediência e fé em Deus.\nEla é um exemplo de amor e serviço."
    },
    {
      name: "Maria (de Betânia)",
      img:mariab,
      resume: "Marta e Maria de Betânia:\nQuem foram? Marta e Maria eram irmãs de Lázaro.\nO que elas fizeram? Marta era ativa e cuidava das tarefas da casa, enquanto Maria preferia ouvir Jesus e aprender com Ele.\nLição para nós: Equilibrar o serviço prático com o tempo para aprender sobre Deus."
    },
    {
      name: "Marta (de Betânia)",
      img:marta,
    ...
    },
    {
      name: "Mateus",
      img:mateus,
      resume: "Mateus\nQuem foi Mateus?\nMateus era um cobrador de impostos.\nEle se tornou um dos doze apóstolos.\nFeitos de Mateus:\nMateus escreveu o Evangelho de Mateus.\nEle nos mostra como Jesus é o Messias prometido.\nLições Importantes:\nMateus nos ensina sobre arrependimento e seguir Jesus."
    },
    {
      name: "Mel",
      img:mel,
    ...
    },
    {
      name: "Miriã",
      img:miria,
      resume: "Miriã:\nQuem foi? Miriã era irmã de Moisés e Aarão.\nO que ela fez? Ela liderou as mulheres em uma dança de celebração após a travessia do Mar Vermelho.\nLição para nós: Celebrar as vitórias e louvar a Deus com alegria."
    },
    {
    ...
    },
    {
      name: "Moisés",
      img:moises,
      resume: "Moisés\nQuem foi Moisés?\nMoisés foi um homem escolhido por Deus para liderar o povo de Israel.\nEle libertou os israelitas da escravidão no Egito.\nAventuras de Moisés:\nAtravessou o Mar Vermelho com o povo.\nRecebeu as Tábuas da Lei com os Dez Mandamentos.\nConduziu o povo pelo deserto por 40 anos.\nLições Importantes:\nMoisés nos ensina sobre obediência, fé e perseverança.\nDeus usa pessoas comuns para grandes propósitos."
    },
    {
      name: "O bom pastor",
      img:pastor,
    ...
    },
    {
      name: "O caminho",
      img:caminho,
      resume: "A Parábola do Caminho\nO Que é o Caminho?\nJesus contou uma história sobre dois caminhos.\nUm era largo e o outro era estreito.\nO Caminho Largo e o Estreito:\nO caminho largo é fácil de seguir, mas leva a problemas.\nO caminho estreito é mais difícil, mas leva à vida eterna.\nComo Escolher o Caminho?\nJesus quer que escolhamos o caminho estreito.\nIsso significa obedecer a Deus, amar os outros e seguir Jesus.\nLições Importantes:\nA vida é cheia de escolhas. Escolha o caminho certo!\nJesus é o único caminho que nos leva a Deus."
    },
    {
      name: "Oliveira",
      img:oliveira,
      resume: "A Oliveira na Bíblia\nO Que é a Oliveira?\nA oliveira é uma árvore que produz azeitonas.\nAs azeitonas são usadas para fazer azeite.\nA Oliveira na Bíblia:\nA oliveira é mencionada muitas vezes na Bíblia.\nEla representa santidade, paz e presença de Deus.\nLições Importantes:\nAssim como a oliveira produz azeite, Deus quer que sejamos cheios do Espírito Santo.\nEle nos unge e nos capacita para viver uma vida de fé e obediência."
    },
    {
      name: "Pães e Peixes",
      img:paespeixes,
    ...
    },
    {
      name: "Pão e Vinho",
      img:paovinho,
      resume: "O Pão e o Vinho na Bíblia\nO Significado do Pão:\nO pão é um alimento básico que tem um significado profundo na Bíblia.\nRepresenta a provisão de Deus para o Seu povo.\nNo Antigo Testamento:\nO pão era usado nas ofertas e nos rituais de adoração.\nEra oferecido a Deus como forma de gratidão e reconhecimento de Sua provisão.\nNo Novo Testamento:\nJesus se identificou como o “pão da vida” em João 6:35.\nEle é a fonte de vida espiritual e plenitude para quem crê Nele.\nO Significado do Vinho:\nO vinho também tem um significado especial na Bíblia.\nSimboliza alegria, comunhão e a morte de Jesus.\nNa Última Ceia:\nJesus instituiu a Santa Ceia com pão e vinho.\nO pão representa Seu corpo e o vinho Seu sangue dado por nós."
    },
    {
      name: "Paulo",
      img:paulo,
      resume: "Paulo\nQuem foi Paulo?\nPaulo era um apóstolo de Jesus.\nEle escreveu muitas cartas na Bíblia.\nFeitos de Paulo:\nEle pregou o evangelho em muitos lugares.\nPaulo enfrentou perseguições e prisões.\nLições Importantes:\nPaulo nos ensina sobre fé, amor e serviço a Deus.\nEle mostrou como Deus pode mudar vidas."
    },
    {
      name: "Pedro",
      img:pedro,
      resume: "Pedro\nQuem foi Pedro?\nPedro era um pescador e um dos doze apóstolos.\nEle era amigo próximo de Jesus.\nFeitos de Pedro:\nPedro andou sobre a água com Jesus.\nEle pregou o primeiro sermão no Dia de Pentecostes.\nLições Importantes:\nPedro nos ensina sobre coragem, arrependimento e fé.\nDeus usa pessoas comuns para grandes coisas."
    },
    {
      name: "Porcos",
      img:porquinhos,
    ...
    },
    {
      name: "Raabe",
      img:raabe,
      resume: "Raabe\nQuem foi Raabe?\nRaabe era uma prostituta em Jericó.\nEla ajudou os espiões israelitas.\nFeitos de Raabe:\nRaabe escondeu os espiões no telhado de sua casa.\nEla e sua família foram poupadas quando Jericó foi conquistada.\nLições Importantes:\nRaabe nos ensina sobre misericórdia, fé e salvação.\nDeus aceita todos que se voltam para Ele."
    },
    {
      name: "Raça de víboras",
      img:viboras,
    ...
    },
    {
      name: "Redes de pesca",
      img:rede,
      resume: "Redes de Pesca na Bíblia\nO Que São Redes de Pesca?\nAs redes de pesca são feitas de cordas e são usadas para pegar peixes.\nElas são lançadas na água e depois puxadas para pegar os peixes.\nRedes de Pesca na Bíblia:\nNa Bíblia, as redes de pesca são mencionadas várias vezes.\nOs pescadores, como Pedro e André, usavam redes para pescar no mar da Galileia.\nA Pesca Maravilhosa:\nJesus ensinou uma lição incrível usando redes de pesca.\nEle disse a Pedro para lançar as redes novamente, mesmo depois de uma noite sem peixes.\nAs redes ficaram tão cheias que quase se romperam!\nLições Importantes:\nAssim como as redes de pesca, Deus nos chama para sermos pescadores de pessoas.\nEle quer que compartilhemos o amor e a mensagem de Jesus com os outros."
    },
    {
      name: "Rei Davi",
      img:davi,
    ...
    },
    {
      name: "Vaso de barro",
      img:vasobarro,
      resume: "Vamos aprender sobre o vaso de barro de forma simples e divertida:\n\nO Que é um Vaso de Barro?\nUm vaso de barro é um objeto feito de argila ou barro.\nPode ser uma tigela, um jarro ou até mesmo um pote.\nO Significado Espiritual do Vaso de Barro:\nNa Bíblia, o vaso de barro é usado como um símbolo.\nRepresenta a fragilidade e a dependência do ser humano em Deus.\nO Oleiro e o Vaso:\nImagine um oleiro habilidoso moldando o barro.\nDeus é como o oleiro, moldando nossas vidas com amor e cuidado.\nLições Importantes:\nAssim como o vaso de barro, somos únicos e especiais.\nDeus nos molda para um propósito e nos restaura quando estamos quebrados.\nLembre-se sempre: você é um vaso nas mãos do Criador!"
    },
    {
      name: "Zaqueu",
      img:zaqueu,
  ...
  Bible:[
    {
      ...
      color:Colors.orange,
      books:[
        {abrev:'gn',title:'Gênesis'},
        {abrev:'ex',title:'Êxodo'},
        {abrev:'lv',title:'Levítico'},
        {abrev:'nm',title:'Números'},
        {abrev:'dt',title:'Deuteronômio'},
      ]
    },
    {
      section:'Livros Históricos (AT)',
      color:Colors.blue,
      books:[
        {abrev:'js',title:'Josué'},
        {abrev:'jz',title:'Juízes'},
        {abrev:'rt',title:'Rute'},
        {abrev:'1sm',title:'1 Samuel'},
        {abrev:'2sm',title:'2 Samuel'},
        {abrev:'1rs',title:'1 Reis'},
        {abrev:'2rs',title:'2 Reis'},
        {abrev:'1cr',title:'1 Crônicas'},
        {abrev:'2cr',title:'2 Crônicas'},
        {abrev:'ed',title:'Esdras'},
        {abrev:'ne',title:'Neemias'},
        {abrev:'et',title:'Ester'},
      ]
    },
    {
      section:'Livros Poéticos',
      color:Colors.lightGreen,
      books:[
        {abrev:'job',title:'Jó'},
        {abrev:'sl',title:'Salmos'},
        {abrev:'pv',title:'Provérbios'},
        {abrev:'ec',title:'Eclesiaster'},
        {abrev:'ct',title:'Cantares'},
      ]
    },
    {
      section:'Livros Proféticos',
      color:Colors.darkBlue,
      books:[
        {abrev:'is',title:'Isaías'},
        {abrev:'jr',title:'Jeremias'},
        {abrev:'lm',title:'Lamentações'},
        {abrev:'ez',title:'Ezequiel'},
        {abrev:'dn',title:'Daniel'},
        {abrev:'os',title:'Oseias'},
        {abrev:'jl',title:'Joel'},
        {abrev:'am',title:'Amós'},
        {abrev:'ob',title:'Obadias'},
        {abrev:'jn',title:'Jonas'},
        {abrev:'mq',title:'Miqueias'},
        {abrev:'na',title:'Naum'},
        {abrev:'hc',title:'Habacuque'},
        {abrev:'sf',title:'Sofonias'},
        {abrev:'ag',title:'Ageu'},
        {abrev:'zc',title:'Zacarias'},
        {abrev:'ml',title:'Malaquias'},
      ]
    },
    {
      section:'Evangelhos',
      color:Colors.yellow,
      books:[
        {abrev:'mt',title:'Mateus'},
        {abrev:'mc',title:'Marcos'},
        {abrev:'lc',title:'Lucas'},
        {abrev:'jo',title:'João'},
      ]
    },
    {
      section:'Livro Histórico (NT)',
      color:Colors.brown,
      books:[{abrev:'at',title:'Atos'}]
    },
    {
      section:'Cartas',
      color:Colors.green,
      books:[
        {abrev:'rm',title:'Romanos'},
        {abrev:'1co',title:'1 Coríntios'},
        {abrev:'2co',title:'2 Coríntios'},
        {abrev:'gl',title:'Gálatas'},
        {abrev:'ef',title:'Efésios'},
        {abrev:'fp',title:'Filipenses'},
        {abrev:'cl',title:'Colossenses'},
        {abrev:'1ts',title:'1 Tessalonicenses'},
        {abrev:'2ts',title:'2 Tessalonicenses'},
        {abrev:'1tm',title:'1 Timóteo'},
        {abrev:'2tm',title:'2 Timóteo'},
        {abrev:'tt',title:'Tito'},
        {abrev:'fm',title:'Filemom'},
        {abrev:'hb',title:'Hebreus'},
        {abrev:'tg',title:'Tiago'},
        {abrev:'1pe',title:'1 Pedro'},
        {abrev:'2pe',title:'2 Pedro'},
        {abrev:'1jo',title:'1 João'},
        {abrev:'2jo',title:'2 João'},
        {abrev:'3jo',title:'3 João'},
        {abrev:'jd',title:'Judas'},
      ]
    },
    {
      section:'Livro da Revelação',
      color:Colors.lightBrown,
      books:[{abrev:'ap',title:'Apocalipse'}]
    }
  ],
  Verses:[
    {
